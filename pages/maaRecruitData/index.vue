...
<div id="maa_recruit_poster">
    <div id="maa_recruit_poster_main">
        ...
        <div id="poster_title_sub">Recruit Big Data</div>
        </div>
        ...
        <div class="poster_block" style="margin-top: 0vw;">
            ...
            <div class="poster_block_content pie_all" id="chart2" ref="chart">
        ...
        <div class="poster_block">
            ...
            <div class="poster_block_title">所有的<span class="text_special">{{maaData.maaTagsDataCount}}条</span>数据中</div>
            <div class="poster_block_content">
            <div class="poster_block_p1">有<span class="text_special">{{maaData.topOperator}}次</span>高级资深干员</div>
        ...
        <div class="poster_block">
            <div class="poster_block_number">3</div>
             <div class="poster_block_title">火神仅出现了<span class="text_special">{{maaData.vulcan}}次</span></div>
            <div class="poster_block_content">
            <div class="poster_block_p1">占到了5星tag的<span class="text_special">{{getProbability(maaData.vulcan,maaData.seniorOperatorCount)}}%</span></div>
            <div class="poster_block_p1"></div>
        ...
        <div class="poster_block">
            ...
            <div class="poster_block_title">在<span class="text_special">{{maaData.seniorOperator}}次</span>资深干员中</div>
            <div class="poster_block_content">
            <div class="poster_block_p1">出现了<span class="text_special">{{maaData.topAndSeniorOperator}}次</span>高级资深干员</div>
            <div class="poster_block_p1"></div>
        ...
        <div class="poster_block">
            ...
            <div class="poster_block_title">小车的出率有<span class="text_special">{{getProbability(maaData.robot,maaData.maaTagsDataCount)}}%</span></div>
            <div class="poster_block_content">
            <div class="poster_block_p1">但其中<span class="text_special">{{getProbability(maaData.robotChoice,maaData.robot)}}%</span>面临黄票的诱惑</div>
            <div class="poster_block_p1"></div>
        ...
        <div id="poster_foot">
        <a href="https://maa.plus"><div class="poster_button" style="width:270px;margin-right:0px;"> {{maaData.maaTagsDataCount}}条数据 来自 <span style="color:orange">MaaAssistantArknights</span></div></a>
...
export default {
  ...
  mounted() {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '一图流 x Maa公开招募大数据' }
    ],
    link: [
