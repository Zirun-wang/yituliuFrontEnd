...
export default {
  ...
  methods: {
    IreneCal() {
      ...
      var Irene_spd = 1.05;
      var front1_spd = 1.05 + parseFloat(this.train1_spd / 100);
      var front2_spd = 1.05 + parseFloat(this.train2_spd / 100);
      var doubleProf1_ms = 8 * 3600000;
      var Irene_ms = 5 * 3600000 + 10 * 60000;
      if ("狙击近卫" === this.char_profession ) {
        ...
        var doubleProf2_front_mm = parseInt((doubleProf2_front_ms - doubleProf2_front_hh * 3600000) / 60000);
        ...
        var doubleProf2_remaining_hh = parseInt(doubleProf2_remaining_ms / 3600000);
        var doubleProf2_remaining_mm = parseInt((doubleProf2_remaining_ms - doubleProf2_remaining_hh * 3600000) /60000);
