...
export default {
  ...
  methods: {
    ...
    compute(name) {
      ...
      this.storeList_copy = this.storeList;
    },

    valueInit() {
      if (this.originium_exist == "") this.originium_exist = 0;
      if (this.orundum_exist == "") this.orundum_exist = 0;
      if (this.permit_exist == "") this.permit_exist = 0;
      if (this.permit10_exist == "") this.permit10_exist = 0;
      if (this.paradox == "") this.paradox = 0;
