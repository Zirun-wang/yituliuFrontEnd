    ...
    <div id="riic_controlPanel">
      ...
      <div class="riic_building">
        ...
        <div class="riic_building_parameter">
          ...
          <el-input class="parameter_inputbox" size="small" placeholder="适合全干员，压榨每一个工具人！"
                    v-model="descriptionH1"></el-input>
        </div>
        <div class="riic_building_parameter">
      ...
      <div class="riic_building">
        ...
        <div class="riic_building_parameter">
          ...
          <el-input size="small" class="parameter_inputbox" placeholder="主力组A" style="width: 90px"
                    v-model="name[0]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="20:00" style="width: 80px"
                    v-model="period_plan0[0]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="23:59" style="width: 80px"
                    v-model="period_plan0[1]"></el-input>
        </div>
        <div class="riic_building_parameter">
          <div class="parameter_text" style="width: 108px;">名称/起止时间</div>
          <el-input size="small" class="parameter_inputbox" placeholder="主力组B" style="width: 90px"
                    v-model="name[1]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="03:00" style="width: 80px"
                    v-model="period_plan1[0]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="10:00" style="width: 80px"
                    v-model="period_plan1[1]"></el-input>
        </div>
        <div class="riic_building_parameter" v-show="'3班'===planTimes">
          <div class="parameter_text" style="width: 108px;">名称/起止时间</div>
          <el-input size="small" class="parameter_inputbox" placeholder="主力组C" style="width: 90px"
                    v-model="name[2]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="10:00" style="width: 80px"
                    v-model="period_plan2[0]"></el-input>
          <el-input size="small" class="parameter_inputbox" placeholder="20:00" style="width: 80px"
                    v-model="period_plan2[1]"></el-input>
        </div>
        <div class="riic_building_parameter">
      ...
      <div class="riic_building">
        ...
        <div class="riic_building_parameter">
          ...
          <div id="export_cover"
               style="position: absolute;width: 235px;height: 40px;margin: -38px 18px 18px 137px;background: #ffffff80"></div>
          <a :href="exportUrl">
        ...
        <div class="riic_building_parameter">
          ...
          <el-input size="small" class="parameter_inputbox" placeholder="id" style="margin-left:12px;width: 150px"
                    v-model="importId"></el-input>
        </div>
        <div class="riic_building_parameter">
          *导出json文件的文件名即为id <br>
          或打开排班文件最末尾中寻找id
    ...
    <div id="riic_workerSets">
      <div class="riic_workerSet">
        <div class="riic_building building_uni">
          ...
          <div class="riic_building_parameter">
            ...
            <el-input size="small" style="width: 128px" class="parameter_inputbox" placeholder="例如：巫恋"
                      v-model="Fiammetta[0]"></el-input>
          </div>
          <div class="riic_building_parameter">
            <div class="parameter_text" style="font-size: 15px">使用顺序</div>
        ...
        <div class="riic_building building_cortrolCenter">
          <div class="riic_building_title">控制中枢
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="control_skip[0]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
            <el-select v-model="control_plan0[0]" filterable placeholder="请选择" size=small>
              <el-option v-for="item in char_CONTROL"
        ...
        <div class="riic_building building_trade">
          <div class="riic_building_title">贸易站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan0_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
            <el-select v-model="trading_plan0_0[0]" filterable placeholder="请选择" size=small>
              <el-option v-for="item in char_TRADING"
                         :key="item" :label="item" :value="item"></el-option>
            </el-select>
        ...
        <div class="riic_building building_trade"
          ...
          <div class="riic_building_title">贸易站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan0_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan0_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan0_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade" v-show="'333' === buildingType">
          <div class="riic_building_title">贸易站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan0_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan0_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan0_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan0_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
            <el-select v-model="manufacture_plan0_0[0]" filterable placeholder="请选择" size=small>
              <el-option v-for="item in char_MANUFACTURE"
                         :key="item" :label="item" :value="item"></el-option>
            </el-select>
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan0_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan0_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan0_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan0_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan0_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan0_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory"
          ...
          <div class="riic_building_title">制造站4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan0_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan0_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan0_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory" v-show="'153' === buildingType||'252' === buildingType">
          <div class="riic_building_title">制造站5
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan0_4[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan0_4[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan0_4[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
            <el-select v-model="power_plan0_0[0]" filterable placeholder="请选择" size=small>
              <el-option v-for="item in char_POWER"
                         :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </div>
        </div>
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan0_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan0_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant" v-show="!('252' === buildingType)">
          <div class="riic_building_title">发电站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan0_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan0_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_meetingRoom">
          <div class="riic_building_title">会客室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_meeting_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_meeting_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_hr">
          <div class="riic_building_title">办公室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_hire_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_hire_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan0_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan0_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan0_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan0_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan0_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan0_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan0_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan0_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan0_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan0_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan0_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan0_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
      ...
      <div class="riic_workerSet">
        ...
        <div class="riic_building building_cortrolCenter">
          <div class="riic_building_title">控制中枢
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="control_skip[1]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade">
          <div class="riic_building_title">贸易站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan1_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade"
          ...
          <div class="riic_building_title">贸易站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan1_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan1_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan1_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade" v-show="'333' === buildingType">
          <div class="riic_building_title">贸易站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan1_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan1_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan1_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan1_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan1_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan1_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan1_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan1_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan1_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan1_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory"
          ...
          <div class="riic_building_title">制造站4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan1_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan1_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan1_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory" v-show="'153' === buildingType||'252' === buildingType">
          <div class="riic_building_title">制造站5
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan1_4[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan1_4[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan1_4[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan1_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan1_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant" v-show="!('252' === buildingType)">
          <div class="riic_building_title">发电站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan1_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan1_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_meetingRoom">
          <div class="riic_building_title">会客室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_meeting_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_meeting_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_hr">
          <div class="riic_building_title">办公室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_hire_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_hire_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan1_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan1_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan1_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan1_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan1_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan1_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan1_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan1_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan1_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan1_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan1_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan1_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
      ...
      <div class="riic_workerSet" v-show="'3班'===planTimes">
        ...
        <div class="riic_building building_cortrolCenter">
          <div class="riic_building_title">控制中枢
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="control_skip[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade">
          <div class="riic_building_title">贸易站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan2_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade"
          ...
          <div class="riic_building_title">贸易站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan2_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan2_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan2_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_trade" v-show="'333' === buildingType">
          <div class="riic_building_title">贸易站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_trading_plan2_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_trading_plan2_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_trading_plan2_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan2_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan2_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan2_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan2_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory">
          <div class="riic_building_title">制造站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan2_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan2_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan2_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory"
          ...
          <div class="riic_building_title">制造站4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan2_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan2_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan2_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_factory" v-show="'153' === buildingType||'252' === buildingType">
          <div class="riic_building_title">制造站5
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_manufacture_plan2_4[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_manufacture_plan2_4[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_manufacture_plan2_4[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant">
          <div class="riic_building_title">发电站2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan2_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan2_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_powerPlant" v-show="!('252' === buildingType)">
          <div class="riic_building_title">发电站3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_power_plan2_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_power_plan2_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_meetingRoom">
          <div class="riic_building_title">会客室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_meeting_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_meeting_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_hr">
          <div class="riic_building_title">办公室
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_hire_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_hire_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍1
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan2_0[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan2_0[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan2_0[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍2
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan2_1[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan2_1[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan2_1[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍3
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan2_2[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan2_2[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan2_2[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
        ...
        <div class="riic_building building_dormitory">
          <div class="riic_building_title">宿舍4
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="顺序入驻" border v-model="switch_dormitory_plan2_3[0]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="补满空位" border v-model="switch_dormitory_plan2_3[1]"></el-checkbox>
            <el-checkbox style="margin:4px 0px 0px 0px;background-color: #ffffff80;vertical-align: top;" size="mini"
                         label="跳过" border v-model="switch_dormitory_plan2_3[2]"></el-checkbox>
          </div>
          <div class="riic_building_operatorArray">
